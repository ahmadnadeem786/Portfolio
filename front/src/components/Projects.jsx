...
import port from '../assets/hero-img.png';
...
const allProjects = [
  {
    title: 'Quick AI',
    description: 'AI-powered content and image generation tool with background & object removal.',
    category: 'React',
    image: quickaiImg,
  ...
  },
  {
    ...
    description: 'Role-based employee task management system with admin & employee views.',
    category: 'React',
    image: emsImg,
  ...
  },
  {
    ...
    description: 'Clean responsive layout using only HTML & CSS.',
    category: 'HTML/CSS',
    image: ecom,
    demoLink: '#',
    codeLink: '#',
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-12 bg-[#101820FF]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex items-center justify-between mb-10 flex-wrap gap-4">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#F2AA4CFF] tracking-widest">02</h2>
        </div>
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {filteredProjects.length > 0 ? (
            filteredProjects.map((project, i) => (
              <div
                key={i}
                className="relative rounded-xl overflow-hidden shadow-lg group cursor-pointer transform hover:scale-[1.03] transition-transform duration-300 border border-gray-700"
